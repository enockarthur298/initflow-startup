            ...
            if (startingIdx > 0) {
              ...
              filteredMessages = [
                ...
                },
                {
                  ...
                  content: `Project Restored. You can revert this message to load the full chat history.
...
${value.content}
        ...
        .catch((error) => {
          ...
          toast.error('Failed to load project: ' + error.message); // More specific error
        });
    } else {
